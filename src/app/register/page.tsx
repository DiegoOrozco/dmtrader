        ...
        <div className="min-h-screen bg-[var(--background)] flex flex-col items-center justify-center px-4 pt-28 pb-12 relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-1.5">Crear Cuenta</h1>
                    <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Únete a la mejor academia premium de trading.</p>
                </div>
                ...
                <div className="bg-white dark:bg-slate-900/60 border border-slate-200/50 dark:border-slate-800 rounded-2xl p-8 shadow-xl">
                    ...
                    {/* Client-side form with inline validation */}
